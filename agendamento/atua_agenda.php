<?php
	...
	$sql = "SELECT id_ag, ambiente, horario, professor, dia , mes FROM tb_agendamento "; 
		...
		<div class="row">
			<div class="col-xs-3  menu_esquerdo">
		 	...
		 	<div class="col-xs-9">
		 		<div class="row">
	   				<div class="col-xs-12">
	    				<h2>Atualizar agendamento do ambiente!</h2> 
				    	...
				    	<tbody>
				    	 <?php 					     
					        ...
					        while( $consulta = mysql_fetch_array($result)) {
					           ...
					           print "<td><a onclick=window.open('atualiza.php?id_ag=$consulta[id_ag]','','width=1100,height=500');> <span class='glyphicon glyphicon-refresh'></span></a></td>";
					           print "</tbody>";
					         } 
